...
public class RecetaService {
    ...
    public List<Receta> busquedaAvanzada(Autor a, Ingrediente i, Double precioMin,
            Double precioMax, Date fMin, Date fMax) {
        ...
        List<Receta> resultadoBusqueda = new ArrayList<Receta>();
        ...
        resultadoBusqueda = query.getResultList();
